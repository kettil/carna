...
const licenseHeuristics: LicenseHeuristics = {
  ...
  'BSD*': /edistribution and use in source and binary forms, with or withou|edistribution and use of this software in source and binary forms, with or withou/u,
